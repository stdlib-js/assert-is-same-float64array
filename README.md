...
```javascript
isSameFloat64Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-float64array@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-same-float64array@v0.2.2-umd/browser.js"></script>
```
